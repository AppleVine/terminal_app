...
def get_wizard_level():
    ...
    while input_level != "quit":
        ...
        if input_level == "quit":
            ...
            your_character = Wizard(3, 3, 4, 2)
            return your_character
        elif input_level == "4":
            your_character = Wizard(4, 4, 4, 3)
            return your_character
        elif input_level == "5":
            your_character = Wizard(5, 4, 4, 3, 2)
            return your_character
        elif input_level == "6":
            your_character = Wizard(6, 4, 4, 3, 3)
            return your_character
        elif input_level == "7":
            your_character = Wizard(7, 4, 4, 3, 3, 1)
            return your_character
        elif input_level == "8":
            your_character = Wizard(8, 4, 4, 3, 3, 2)
            return your_character
        elif input_level == "9":
            your_character = Wizard(9, 4, 4, 3, 3, 3, 1)
            return your_character
        elif input_level == "10":
            your_character = Wizard(10, 5, 4, 3, 3, 3, 2)
            return your_character
        elif input_level == "11":
            your_character = Wizard(11, 5, 4, 3, 3, 3, 2, 1)
            return your_character
        elif input_level == "12":
            your_character = Wizard(12, 5, 4, 3, 3, 3, 2, 1)
            return your_character
        elif input_level == "13":
            your_character = Wizard(13, 5, 4, 3, 3, 3, 2, 1, 1)
            return your_character
        elif input_level == "14":
            your_character = Wizard(14, 5, 4, 3, 3, 3, 2, 1, 1)
            return your_character
        elif input_level == "15":
            your_character = Wizard(15, 5, 4, 3, 3, 3, 2, 1, 1, 1)
            return your_character
        elif input_level == "16":
            your_character = Wizard(16, 5, 4, 3, 3, 3, 2, 1, 1, 1)
            return your_character
        elif input_level == "17":
            your_character = Wizard(17, 5, 4, 3, 3, 3, 2, 1, 1, 1, 1)
            return your_character
        elif input_level == "18":
            your_character = Wizard(18, 5, 4, 3, 3, 3, 3, 1, 1, 1, 1)
            return your_character
        elif input_level == "19":
            your_character = Wizard(19, 5, 4, 3, 3, 3, 3, 2, 1, 1, 1)
            return your_character
        elif input_level == "20":
            your_character = Wizard(20, 5, 4, 3, 3, 3, 3, 2, 2, 1, 1)
            return your_character
        else:
